...
app.get("/team/aarontang", isLoggedIn, (req, res, next) => {
  res.render("team/aarontang");
});

app.get("/team/harryyu", isLoggedIn, (req, res, next) => {
  res.render("team/harryyu");
});

app.get("/team/zaredcohen", isLoggedIn, (req, res, next) => {
  res.render("team/zaredcohen");
});

app.get("/team/denisezhong", isLoggedIn, (req, res, next) => {
  res.render("team/denisezhong");
});
